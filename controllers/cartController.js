...
exports.addToCart = async (req, res) => {
  try {
    ...
    // Проверяем только наличие товара, а не его количество
    if (product.stock <= 0) {
      return res.status(400).json({ message: 'Товар отсутствует на складе' });
    }

    // Дальнейшая логика добавления в корзину...
